                                ...
                                <table style="background: #336f85; border: 0px; border-radius: 0px; width: 599px; height: 53px; margin-left: auto; margin-right: auto;"
                                    ...
                                    <tr>
                                        ...
                                        <td class="tw-card-header"
                                            ...
                                            align="center"><span
                                                style="font-weight: 600;">이메일 확인이 필요합니다.</span></td>
                                ...
                                <table dir="ltr" style="border: 0; width: 100%;" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            ...
                                            <span style="font-weight: 400;"><strong>KYUNGSEO.PoC</strong> 가입을 환영합니다.</span><br/><br/><span
                                                style="font-weight: 400;">회원 가입 절차를 마무리하기 위해서 다음 링크를 클릭하여 이메일 주소를 확인하여야 등록하신 계정을 활성화할 수 있습니다.</span>
                                            ...
                                            <p class=""
                                               style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                질문이나 제안 사항이 있는 경우, &nbsp;<a
                                                    ...
                                                    href="https://github.com/kyungseo" target="_blank" rel="noopener">여기</a>에 접속하시기 바랍니다.</p>
                                            <p class="tw-signoff"
                                               style="margin: 45px 0 5px; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                Kyungseo.Park@gmail.com, <br/> KYUNGSEO.PoC</p>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
